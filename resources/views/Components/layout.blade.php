...
<html lang="en">
    ...
    <nav class="bg-gray-800">
      ...
      <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3" text-align: right>
          <div class="flex items-center px-5" text-align: right>
            <div class="shrink-0" text-align: right>
              <img class="size-10 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" text-align: right>
            </div>
            <div class="ml-3 text-align: right">
